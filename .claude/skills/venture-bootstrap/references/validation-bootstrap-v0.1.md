...
# venture-bootstrap v0.1 validation protocol

Preserved for upgrading validation-first ventures. Its universal application-
code and pricing-experiment gates are superseded by ADR-001.
