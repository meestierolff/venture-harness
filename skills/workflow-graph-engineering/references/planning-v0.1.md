...
# workflow-graph-engineering v0.1 planning protocol

Preserved for migration context. The v0.2 router uses the executable `vh`
runtime while retaining bounded nodes, data-only edges, deterministic plumbing,
failure isolation, and explicit approvals.
