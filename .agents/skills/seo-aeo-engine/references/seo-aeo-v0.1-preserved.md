...
# Preserved v0.1 discovery playbook

This is the complete SEO/AEO guidance added in commit `de69705`. Venture
Harness v0.2 keeps it as a migration reference while the concise router points
to focused playbooks. Nothing in this file is an availability claim.
