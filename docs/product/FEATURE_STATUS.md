...
| Rough-prose and product-build model execution     | Unavailable      | Public concrete hosts accept no caller executor and stop before invocation; fixture hosts test graph logic                                                       | Install and audit an unforgeable outer read-isolation driver              |
