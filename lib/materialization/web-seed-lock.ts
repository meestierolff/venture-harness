/**
 * Generated with pnpm 9.15.9 from the exact agentic-web-saas@0.2.0
 * dependency contract. Regenerate deliberately whenever that contract changes.
 */
export const AGENTIC_WEB_PNPM_LOCK = String.raw`lockfileVersion: '9.0'
...
importers:
  ...
  .:
    dependencies:
      next:
        specifier: 15.5.21
        version: 15.5.21(@playwright/test@1.62.1)(react-dom@19.2.7(react@19.2.7))(react@19.2.7)
      react:
        specifier: 19.2.7
        version: 19.2.7
      react-dom:
...
snapshots:
  ...
  next@15.5.21(@playwright/test@1.62.1)(react-dom@19.2.7(react@19.2.7))(react@19.2.7):
    dependencies:
      '@next/env': 15.5.21
      '@swc/helpers': 0.5.15
      caniuse-lite: 1.0.30001809
